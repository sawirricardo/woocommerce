 ...
 * them roleless.
 *
 * The preset layer maps each preset (see POSPreset) to a bundle of `pos_*` caps
 * and assigns or clears them per user via set_pos_preset(). The assigned preset
 * is recorded in `_woocommerce_pos_preset` user meta for the UI; the caps remain
 * the authorization signal, so a stray meta value alone grants nothing.
 *
 * @since 11.0.0
 * @internal
 */
